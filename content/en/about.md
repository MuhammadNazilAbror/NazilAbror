...
# For "Languages" and "Interests", write each item on its own line starting with "- " and set kind so they render as pills.
quickfacts:
  - icon: "briefcase"
    title: "Current Role"
    value: "Student at Wikrama Bogor Vocational School, majoring in TJKT"
  - icon: "graduation-cap"
    title: "Education"
    value: |
